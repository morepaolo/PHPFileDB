...
sql_terminal_character ::=
		sql_language_character | sql_embedded_language_character.
...
sql_special_character ::=
		...
		quote | left paren | right paren | asterisk |
		plus_sign | comma | minus sign | period | solidus |
		colon |	semicolon | less than operator | greater than operator |
		equals operator | question mark | underscore | vertical bar
