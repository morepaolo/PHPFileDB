...
static $yy_action = array(
 /*     0 */    10,   11,    9,   22,    5,    1,    2,    7,    3,    6,
 /*    10 */     9,    4,   34,    8,
);
static $yy_lookahead = array(
 /*     0 */     2,    3,    4,   16,   17,    1,   18,    2,   20,   19,
 /*    10 */     4,   18,   23,   19,
);
...
static $yy_default = array(
 /*     0 */    21,   21,   21,   21,   21,   12,   13,   18,   14,   17,
 /*    10 */    15,   16,
);
...
static $yyTokenName = array( 
  ...
  'OP_GT',         'OP_LTEQ',       'OP_GTEQ',       'error',       
  'query',         'query_specification',  'select_list',   'table_expression',
  'set_quantifier',  'truth_value',   'comp_op',     
);
...
static $yyRuleName = array(
 ...
 /*   1 */ "query_specification ::= SELECT select_list table_expression",
 /*   2 */ "query_specification ::= SELECT set_quantifier select_list table_expression",
 /*   3 */ "set_quantifier ::= ALL",
 /*   4 */ "set_quantifier ::= DISTINCT",
 /*   5 */ "select_list ::= NULLX",
 /*   6 */ "table_expression ::= ALL",
 /*   7 */ "truth_value ::= TRUE| FALSE| UNKNOWN",
 /*   8 */ "comp_op ::= OP_EQ| OP_GTLT| OP_LT| OP_GT| OP_LTEQ| OP_GTEQ",
);
